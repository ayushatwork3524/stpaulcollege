...
public class LeavingCertificateController {
    ...
    private final LCService tcService;

    private final StudentService studentService;

    private final StudentRepo studentRepo;

    public LeavingCertificateController(LeavingCertificateRepository transferCertificateRepository, LCService tcService,
    ...
    @GetMapping("/request")
    public ResponseEntity<?> generateTc(@RequestParam String studentId) throws IOException {
        ...
        LeavingCertificate transferCertificate = LeavingCertificate.builder()
                .student(student)
